...
// Função helper para usar ícones
...
// Inicializa os ícones após o render
window.Icon = Icon;
window.initLucide = () => lucide.createIcons();
// Exporta para uso global
window.icons = {
    TrashIcon, EditIcon, ShieldIcon, ExportIcon, ImportIcon, UndoIcon,
    RedoIcon, HelpIcon, LogoutIcon, GoogleIcon, SortAscIcon, SortDescIcon,
    NeutralSortIcon, AlertTriangleIcon, ResetIcon, CalculatorIcon,
    AdjustIcon, InfoIcon, UsersIcon, SettingsIcon
};
