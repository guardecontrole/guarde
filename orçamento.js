const OrcamentoPage = ({ data }) => { 
    const { useState } = React;
    const { ResponsiveContainer, ComposedChart, CartesianGrid, XAxis, YAxis, Tooltip, Legend, Line } = Recharts;
    ...
    return ( 
        <div id="financial-chart-budget" className="bg-gray-800 p-6 rounded-xl shadow-md animate-fade-in"> 
            <h2 className="text-2xl font-semibold text-gray-200 mb-4">Evolução Financeira (Orçamento)</h2> 
            <p className="text-gray-400 mb-6">Visualização detalhada do comportamento do seu orçamento ao longo dos últimos 12 meses.</p>
